...
beta = st.sidebar.slider("Order Smoothing (β)", 0.4, 1.0, 0.8, help="1.0 = React instantly (Standard). Lower = smooth orders.")

alpha = st.sidebar.slider("Forecast Responsiveness (α)", 0.05, 0.90, 0.10, help="Higher = reacts faster to recent demand. Lower = smooths out noise.")
